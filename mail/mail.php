...
$outgoingServerAddress      = 'smtp.live.com'; // Consult your hosting provider.
$outgoingServerPort         = '547';                  // Options: '587' , '25' - Consult your hosting provider.
...
$sendingAccountUsername     = 'frobotix@hotmail.com';
$sendingAccountPassword     = 'foodlovers12';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'frobotix@outlook.com'; // REQUIRED value.
$recipientName              = 'Frobotix';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Your Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Get Nomad';                // REQUIRED value. This is used when a name or email is not collected from the website form
